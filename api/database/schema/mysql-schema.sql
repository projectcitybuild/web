...
CREATE TABLE `account_email_changes` (
  `account_email_change_id` int(10) unsigned NOT NULL AUTO_INCREMENT,
  `account_id` int(10) unsigned NOT NULL,
  `token` varchar(255) NOT NULL,
  `email_previous` varchar(255) NOT NULL,
  `email_new` varchar(255) NOT NULL,
  `is_previous_confirmed` tinyint(1) NOT NULL,
  `is_new_confirmed` tinyint(1) NOT NULL,
  `created_at` timestamp NULL DEFAULT NULL,
  `updated_at` timestamp NULL DEFAULT NULL,
  PRIMARY KEY (`account_email_change_id`),
  KEY `account_email_changes_token_email_previous_email_new_index` (`token`,`email_previous`,`email_new`),
...
CREATE TABLE `badges` (
  ...
  `unicode_icon` varchar(255) NOT NULL,
  PRIMARY KEY (`id`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci;
/*!40101 SET character_set_client = @saved_cs_client */;
...
CREATE TABLE `builder_rank_applications` (
  `id` bigint(20) unsigned NOT NULL AUTO_INCREMENT,
  `account_id` int(10) unsigned NOT NULL,
  `minecraft_alias` varchar(255) NOT NULL,
  `current_builder_rank` varchar(255) NOT NULL,
  `build_location` varchar(255) NOT NULL,
...
CREATE TABLE `donation_perks` (
  ...
  `created_at` timestamp NULL DEFAULT NULL,
  `updated_at` timestamp NULL DEFAULT NULL,
  `last_currency_reward_at` datetime DEFAULT NULL,
...
CREATE TABLE `game_ip_bans` (
  ...
  `unban_type` varchar(255) DEFAULT NULL,
  PRIMARY KEY (`id`),
...
CREATE TABLE `game_player_bans` (
  ...
  `banned_alias_at_time` varchar(255) NOT NULL COMMENT 'Alias of the player at ban time for logging purposes',
...
CREATE TABLE `groups` (
  ...
  `discourse_name` varchar(255) DEFAULT NULL,
  `minecraft_name` varchar(255) DEFAULT NULL,
...
/*!40101 SET character_set_client = @saved_cs_client */;
DROP TABLE IF EXISTS `minecraft_auth_codes`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!50503 SET character_set_client = utf8mb4 */;
CREATE TABLE `minecraft_auth_codes` (
  `minecraft_auth_code_id` bigint(20) unsigned NOT NULL AUTO_INCREMENT,
  ...
  `created_at` timestamp NULL DEFAULT NULL,
  `updated_at` timestamp NULL DEFAULT NULL,
  PRIMARY KEY (`minecraft_auth_code_id`),
  UNIQUE KEY `minecraft_auth_codes_uuid_unique` (`uuid`),
  KEY `minecraft_auth_codes_token_index` (`token`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci;
/*!40101 SET character_set_client = @saved_cs_client */;
...
CREATE TABLE `server_categories` (
  `server_category_id` int(10) unsigned NOT NULL AUTO_INCREMENT,
  `name` varchar(255) NOT NULL,
  `display_order` int(11) NOT NULL,
  `created_at` timestamp NULL DEFAULT NULL,
  `updated_at` timestamp NULL DEFAULT NULL,
  PRIMARY KEY (`server_category_id`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci;
/*!40101 SET character_set_client = @saved_cs_client */;
DROP TABLE IF EXISTS `server_token_scopes`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!50503 SET character_set_client = utf8mb4 */;
CREATE TABLE `server_token_scopes` (
  `id` int(10) unsigned NOT NULL AUTO_INCREMENT,
  `scope` varchar(255) NOT NULL,
  PRIMARY KEY (`id`),
  KEY `server_token_scopes_scope_index` (`scope`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci;
/*!40101 SET character_set_client = @saved_cs_client */;
DROP TABLE IF EXISTS `server_token_scopes_pivot`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!50503 SET character_set_client = utf8mb4 */;
CREATE TABLE `server_token_scopes_pivot` (
  `id` bigint(20) unsigned NOT NULL AUTO_INCREMENT,
  `token_id` int(10) unsigned NOT NULL,
  `scope_id` int(10) unsigned NOT NULL,
  PRIMARY KEY (`id`),
  KEY `server_token_scopes_pivot_token_id_foreign` (`token_id`),
  KEY `server_token_scopes_pivot_scope_id_foreign` (`scope_id`),
  CONSTRAINT `server_token_scopes_pivot_scope_id_foreign` FOREIGN KEY (`scope_id`) REFERENCES `server_token_scopes` (`id`),
  CONSTRAINT `server_token_scopes_pivot_token_id_foreign` FOREIGN KEY (`token_id`) REFERENCES `server_tokens` (`id`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci;
/*!40101 SET character_set_client = @saved_cs_client */;
...
CREATE TABLE `servers` (
  ...
  `server_category_id` int(10) unsigned NOT NULL,
  `name` varchar(255) NOT NULL,
  `ip` varchar(255) NOT NULL,
  `ip_alias` varchar(255) DEFAULT NULL COMMENT 'An alternative address to connect to the server',
  `port` varchar(255) DEFAULT NULL,
  `game_type` int(10) unsigned NOT NULL COMMENT 'Type of game server, used to determine an adapter to use for status querying',
  `is_port_visible` tinyint(1) NOT NULL DEFAULT 1 COMMENT 'Whether the port will be displayed',
  `is_querying` tinyint(1) NOT NULL DEFAULT 1,
  `is_visible` tinyint(1) NOT NULL DEFAULT 1 COMMENT 'Whether the server is visible in the server feed',
  `display_order` int(11) NOT NULL,
  `is_online` tinyint(1) NOT NULL DEFAULT 0,
  `num_of_players` int(11) NOT NULL DEFAULT 0,
  `num_of_slots` int(11) NOT NULL DEFAULT 0,
  `last_queried_at` datetime DEFAULT NULL,
  `created_at` timestamp NULL DEFAULT NULL,
  `updated_at` timestamp NULL DEFAULT NULL,
  PRIMARY KEY (`server_id`),
  KEY `servers_server_category_id_foreign` (`server_category_id`),
  CONSTRAINT `servers_server_category_id_foreign` FOREIGN KEY (`server_category_id`) REFERENCES `server_categories` (`server_category_id`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci;
/*!40101 SET character_set_client = @saved_cs_client */;
