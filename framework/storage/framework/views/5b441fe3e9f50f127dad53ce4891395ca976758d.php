<?php /* /var/www/resources/views/front/layouts/master.blade.php */ ?>
<!DOCTYPE html>
<html lang="en">
    <head>    
        <meta charset="utf-8">
        ...
        <meta property="og:title"       content="<?php echo $__env->yieldContent('title', 'Project City Build'); ?>">
        <meta property="og:description" content="<?php echo $__env->yieldContent('description'); ?>">
        <meta property="og:site_name"   content="Project City Build">
        <meta property="og:type"        content="website">
        <meta property="og:locale"      content="en_US">

        <meta name="twitter:card"       content="<?php echo $__env->yieldContent('description'); ?>">
        <meta name="twitter:site"       content="@PCB_Minecraft">


        <title><?php echo $__env->yieldContent('title', 'Project City Build'); ?></title>

        <link rel="stylesheet" href="<?php echo e(mix('assets/css/app.css')); ?>">
        <link rel="icon" type="type/x-icon" href="<?php echo e(asset('assets/favicon.ico')); ?>">
        ...
        <script defer src="<?php echo e(mix('assets/js/manifest.js')); ?>"></script>
        <script defer src="<?php echo e(mix('assets/js/vendor.js')); ?>"></script>
        <script defer src="<?php echo e(mix('assets/js/app.js')); ?>"></script>
    ...
    <body>
        ...
        <nav id="main-nav">
            <div class="container">
                <ul>
                    ...
                    <li><a href="<?php echo e(route('banlist')); ?>">Ban List</a></li>
                </ul>
                ...
                <ul>
                    ...
                    <?php if(Auth::check()): ?>
                        <li>
                            ...
                            <ul>
                                <li><a href="<?php echo e(route('front.account.settings')); ?>">Account Settings</a></li>
                    ...
                    <?php else: ?>
                        <li><a href="<?php echo e(route('front.login')); ?>">Login</a></li>
                    <?php endif; ?>
                </ul>
            </div>
        </nav>
        ...
        <main>
            ...
            ?>
            <header class="header <?php echo e(!$isHomepage ? 'header--thin' : ''); ?>">
                <div class="container header__container">
                    <div class="header__left">
                        <img class="header__logo <?php echo e(!$isHomepage ? 'header__logo--nopadding' : ''); ?>" src="<?php echo e(asset('assets/images/logo.png')); ?>" alt="Project City Build" />
                    
                        <?php echo $__env->renderWhen($isHomepage, 'front.components.server-feed', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path'])); ?>
                    </div>
                    ...
                    <div class="header__right">
                        ...
                        <div class="hero">
                            ...
                            <div class="hero__slogan">
                                ...
                                Over <span class="accent strong"><?php echo e(number_format($playerCount) ?: 0); ?></span> registered players and always growing.
                            </div>

                            <div class="hero__actions">
                                <?php if(auth()->guard()->guest()): ?>
                                    <a class="hero__button" href="<?php echo e(route('front.register')); ?>">
                                        <i class="fas fa-mouse-pointer"></i>
                                        Join Us
                                    </a>
                                    <a class="hero__button hero__button--bordered" href="<?php echo e(route('front.login')); ?>">
                                        Login
                                    </a>
                                <?php endif; ?>
                ...
                <div class="container footer__container">
                    <div class="footer__left">
                        <ul class="footer__bullets">
                            ...
                            <li><i class="fas fa-check-circle"></i> <a href="<?php echo e(route('terms')); ?>">Terms of Service</a></li>
                            <li><i class="fas fa-check-circle"></i> <a href="<?php echo e(route('privacy')); ?>">Privacy Policy</a></li>
                        </ul>
                        <ul class="footer__bullets">
        ...
        <?php echo $__env->yieldPushContent('body-js'); ?>
