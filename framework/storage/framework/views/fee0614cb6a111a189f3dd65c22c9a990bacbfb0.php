<?php /* /var/www/resources/views/front/components/sidebar.blade.php */ ?>
<div class="donate-panel card card--primary">
    ...
    <div class="donate-panel__container">
        ...
        <div class="progress progress--accent">
            <div class="progress__bar">
                <div class="progress__bar__fill" style="width: <?php echo e($donations['percentage'] ?: 1); ?>%"></div>
            </div>
    ...
    <div class="donate-panel__stats">
        <div class="stats-container">
            <div class="stat">
                <span class="stat__figure">$<?php echo e($donations['total'] ?: 0); ?></span>
                <span class="stat__heading">Funds Raised</span>
            </div>
            <div class="stat">
                <span class="stat__figure"><?php echo e($donations['remainingDays'] ?: '?'); ?></span>
    ...
    <div class="donate-panel__container">
        <a class="button button--large button--secondary" href="<?php echo e(route('front.donate')); ?>">
            Donate
        </a>
