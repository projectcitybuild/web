                        ...
                        <div class="space-y-4">
                            <div class="space-y-2">
                                <dl class="flex items-center justify-between gap-4">
                                    ...
                                    <dd class="text-base font-medium text-gray-900 dark:text-white">{{ group.alias }}</dd>
                                </dl>
                                <dl class="flex items-center justify-between gap-4">
                                    <dt class="text-gray-500 dark:text-gray-400">Group Type</dt>
                                    <dd class="text-base font-medium text-gray-900 dark:text-white">{{ group.group_type }}</dd>
                                </dl>
                                <dl class="flex items-center justify-between gap-4">
                                    <dt class="text-gray-500 dark:text-gray-400">Minecraft Name</dt>
                                    <dd class="text-base font-medium text-gray-900 dark:text-white">{{ group.minecraft_name }}</dd>
                                </dl>
                                <dl class="flex items-center justify-between gap-4">
                                    <dt class="text-gray-500 dark:text-gray-400">Minecraft Display Name</dt>
                                    <dd class="text-base font-medium text-gray-900 dark:text-white">{{ group.minecraft_display_name }}</dd>
                                </dl>
                                <dl class="flex items-center justify-between gap-4">
                                    <dt class="text-gray-500 dark:text-gray-400">Minecraft Hover Text</dt>
                                    <dd class="text-base font-medium text-gray-900 dark:text-white">{{ group.minecraft_hover_text }}</dd>
                                </dl>
                                <dl class="flex items-center justify-between gap-4">
                                    <dt class="text-gray-500 dark:text-gray-400">Display Priority</dt>
                                    <dd class="text-base font-medium text-gray-900 dark:text-white">{{ group.display_priority }}</dd>
                                </dl>
                            </div>
                        </div>
                    </div>
