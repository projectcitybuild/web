...
<div class="row mb-3">
    ...
    <div class="col-sm-9">
        <input type="text" id="display_order" name="display_order" class="form-control" placeholder="1"
               value="{{ old('display_order', $server->display_order) }}">
    </div>
</div>
<div class="row mb-3">
    ...
    <div class="col-sm-9">
        <select name="game_type">
            @foreach (\App\Core\Data\GameType::cases() as $gameType)
                <option
