        ...
        <table class="table highlight-linked">
            ...
            @foreach($groups as $group)
                <tr id="group-{{ $group->getKey() }}">
                    ...
                    <td><x-manage::bs.fa-boolean :data="$group->is_default" false-class="text-muted" /></td>
                    <td><x-manage::bs.fa-boolean :data="$group->is_staff" false-class="text-muted" /></td>
                    <td><x-manage::bs.fa-boolean :data="$group->is_admin" false-class="text-muted" /></td>
