    ...
    <main class="page settings">
        ...
        <div class="settings__content">
            <div class="settings__section" id="change-password">
                ...
                @include('front.pages.account.settings._password')
            </div>

            <div class="settings__section" id="settings-2fa">
                <h2 class="settings__section-heading">2-Factor Authentication</h2>

                <p class="form__description">2FA protects your account by requiring a one-time code generated by your phone to sign in.</p>
