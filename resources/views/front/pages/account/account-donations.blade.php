        ...
        <div class="card card--divided">
            ...
            @if($donations->count() == 0)
                <div class="card__body card__body--padded">
                    ...
                    <p class="mt-0">If you've donated, but it hasn't appeared here, please contact PCB staff via <a href="https://forums.projectcitybuild.com/c/support/">our discussion forums</a> or Discord.</p>
                </div>
            @else
                ...
                <table class="table table--striped">
                    ...
                    @foreach($donations as $donation)
                        <tr>
                            ...
                            <td>
                                @if($donation->perks()->first()->is_lifetime_perks)
                                    Lifetime
                                @else
                                    {{ $donation->perks()->first()->expires_at->toFormattedDateString() }}
                                @endif
                            </td>
                            <td>
                                {{ $donation->perks()->first()->humanReadableStatus() }}
                            </td>
                        </tr>
                    @endforeach
                    </tbody>
