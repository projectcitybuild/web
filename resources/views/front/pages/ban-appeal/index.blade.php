            ...
            <div class="-mx-4 flex flex-wrap">
                <div class="w-full px-4">
                    <div class="mx-auto mb-[60px] max-w-[650px] text-center">
                        ...
                        <p class="text-base text-gray-500 mt-8 leading-loose">
        ...
        <section class="max-w-screen-lg mx-auto px-6">
            <div class="flex flex-col md:flex-row justify-between gap-6">
                <div class="flex-grow md:w-0 rounded-xl border border-gray-200 bg-gray-50 p-8 flex flex-col">
                    ...
                    <h2 class="text-3xl font-bold mt-4">Select from list</h2>

                    <div class="text-gray-500 text-sm mt-5 leading-loose">
                ...
                <div class="flex-grow md:w-0 rounded-xl border border-gray-200 bg-gray-50 p-8 flex flex-col">
                    ...
                    <h2 class="text-3xl font-bold mt-4">Fill out the form</h2>
