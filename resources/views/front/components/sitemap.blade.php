    ...
    <div class="container"{!! isset($animated) && $animated ? ' data-aos="fade-up"' : '' !!}>
        ...
        <div class="footer-links">
            ...
            <div class="footer-links__category">
                <h2>Archived</h2>
                <ul>
                    <li><i class="bullet fas fa-archive"></i> <a href="{{ route('wiki') }}">Community Wiki</a></li>
                    <li><i class="bullet fas fa-archive"></i> <a href="https://forums.projectcitybuild.com/">Forums</a></li>
                </ul>
            </div>
        </div>
    </div>
