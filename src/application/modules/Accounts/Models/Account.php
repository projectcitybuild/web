...
namespace Application\Modules\Accounts\Models;
...
class Account extends Authenticatable
{
    ...
    {
        return $this->belongsTo('Application\Modules\Players\Models\MinecraftPlayer', 'account_id', 'account_id');
    }

    public function linkedSocialAccounts()
    {
        return $this->hasMany('Application\Modules\Accounts\Models\AccountLink', 'account_id', 'account_id');
    }
