...
class MinecraftPlayerLookupService_Test extends TestCase {
     ...
     * @return void
     */
    function testGetByUuid_whenExists_returnsMinecraftPlayer() {
     ...
     * @return void
     */
    function testGetByUuid_whenNotExists_returnsNull() {
        $test = resolve(MinecraftPlayerLookupService::class);
        $result = $test->getByUuid('test_uuid');
     ...
     * @return void
     */
    function testGetByAlias_whenExists_returnsMinecraftPlayer() {
        $player = factory(MinecraftPlayer::class)->create();
     ...
     * @return void
     */
    function testGetOrCreate_whenExists_returnsMinecraftPlayer() {
        $player = factory(MinecraftPlayer::class)->create([
            'uuid' => 'test_uuid',
        ]);
     ...
     * @return void
     */
    function testGetOrCreate_whenNotExists_createsMinecraftPlayer() {
        $test = resolve(MinecraftPlayerLookupService::class);
     ...
     * @return void
     */
    function testGetOrCreate_whenNotExists_andAliasGiven_createsWithAlias() {
        $test = resolve(MinecraftPlayerLookupService::class);
