...
class BanAuthorisationService_Test extends TestCase {
     ...
     * @return void
     */
    function testIsAllowedToBan_whenAllowedGlobalBan_returnsTrue() {
     ...
     * @return void
     */
    function testIsAllowedToBan_whenDisallowedGlobalBan_returnsFalse() {
        $test = new BanAuthorisationService($this->loggerMock);
     ...
     * @return void
     */
    function testIsAllowedToBan_whenAllowedLocalBan_returnsTrue() {
        $test = new BanAuthorisationService($this->loggerMock);
     ...
     * @return void
     */
    function testIsAllowedToBan_whenDisallowedLocalBan_returnFalse() {
        $test = new BanAuthorisationService($this->loggerMock);
     ...
     * @return void
     */
    function testIsAllowedToUnban_whenGlobalBan_andCanGlobalBan_returnsTrue() {
        $test = new BanAuthorisationService($this->loggerMock);
     ...
     * @return void
     */
    function testIsAllowedToUnban_whenGlobalBan_andCannotGlobalBan_returnsFalse() {
        $test = new BanAuthorisationService($this->loggerMock);
     ...
     * @return void
     */
    function testIsAllowedToUnban_whenLocalBan_andSameServer_andCanLocalBan_returnsTrue() {
        $test = new BanAuthorisationService($this->loggerMock);
     ...
     * @return void
     */
    function testIsAllowedToUnban_whenLocalBan_andSameServer_butCannotLocalBan_returnsFalse() {
        $test = new BanAuthorisationService($this->loggerMock);
     ...
     * @return void
     */
    function testIsAllowedToUnban_whenLocalBan_andCanLocalBan_butDifferentServer_returnsFalse() {
        $test = new BanAuthorisationService($this->loggerMock);
     ...
     * @return void
     */
    function testIsAllowedToUnban_whenLocalBan_butDifferentServer_andCanGlobalBan_returnsTrue() {
        $test = new BanAuthorisationService($this->loggerMock);
