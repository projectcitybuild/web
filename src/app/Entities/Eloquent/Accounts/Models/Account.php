...
namespace App\Entities\Eloquent\Accounts\Models;
...
final class Account extends Authenticatable
{
    ...
    {
        return $this->hasMany('App\Entities\Eloquent\Players\Models\MinecraftPlayer', 'account_id', 'account_id');
    }

    public function linkedSocialAccounts()
    {
        return $this->hasMany('App\Entities\Eloquent\Accounts\Models\AccountLink', 'account_id', 'account_id');
    }
