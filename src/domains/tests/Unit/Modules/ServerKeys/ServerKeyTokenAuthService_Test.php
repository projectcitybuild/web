...
class ServerKeyTokenAuthService_Test extends TestCase
{
     ...
     * @return void
     */
    public function testGetAuthHeader_nullHeader_throwsException()
    {
        $this->expectException(ForbiddenException::class);
     ...
     * @return void
     */
    public function testGetServerKey_whenValidToken_returnsKey()
    {
     ...
     * @return void
     */
    public function testGetServerKey_whenExpiredToken_throwsException()
    {
     ...
     * @return void
     */
    public function testGetServerKey_whenTokenMissingKey_throwsException()
    {
     ...
     * @return void
     */
    public function testGetServerKey_whenTokenNotFound_throwsException()
    {
        $this->expectException(UnauthorisedTokenException::class);
